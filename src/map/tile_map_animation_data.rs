...
use zander_game_core_rs::raylib::{animation_data::SpriteAnimationData, sprite::Sprite};
...
// (ANIM_NAME, bitmask)
pub static LAKE_TILE_SHORE_ANIMATION_REFERENCE: [SpriteAnimationData; 15] = [
    // TOP, 1
    SpriteAnimationData {
        frames: &[Sprite::new(16, 16, 8, 8), Sprite::new(24, 16, 8, 8)],
        frame_duration: SHORE_AND_CORNER_AND_RIVER_FRAME_DURATION,
        should_loop: true,
    },
    // RIGHT, 2
    SpriteAnimationData {
...
// (ANIM_NAME, bitmask)
pub static LAKE_TILE_CORNER_ANIMATION_REFERENCE: [SpriteAnimationData; 15] = [
    // TOP LEFT CORNER, 1
    SpriteAnimationData {
...
pub static LAKE_TILE_ANIM: SpriteAnimationData = SpriteAnimationData {
    frames: &[
        Sprite::new(16, 0, 8, 8),
        Sprite::new(24, 0, 8, 8),
        Sprite::new(32, 0, 8, 8),
...
pub static RIVER_TILE_STRAIGHT_ANIMS: [(SpriteAnimationData, SpriteFlip); 4] = [
    // NORTH
    (
        SpriteAnimationData {
            frames: &[
...
pub static RIVER_TILE_CORNER_ANIMS: [(SpriteAnimationData, SpriteFlip); 8] = [
    // DOWN TO RIGHT, 0
    (
        SpriteAnimationData {
            frames: &[
...
pub static RIVER_TILE_T_SECTION_ANIMS: [(SpriteAnimationData, SpriteFlip); 8] = [
    // IN RIGHT FLOWING UP
    (
        SpriteAnimationData {
            frames: &[
...
pub static OUTLETS_ANIMS: [(SpriteAnimationData, SpriteFlip); 4] = [
...
pub static INLET_ANIMS: [(SpriteAnimationData, SpriteFlip); 4] = [
    // IN UP
    (
        SpriteAnimationData {
            frames: &[
